async function testEndpoints() {
  const urls = [
    { name: 'GET resident', url: 'http://localhost:3333/admin/resident', method: 'GET' },
    { name: 'GET house', url: 'http://localhost:3333/admin/house', method: 'GET' },
    { name: 'GET datawarga', url: 'http://localhost:3333/admin/datawarga', method: 'GET' }
  ];
