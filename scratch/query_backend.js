async function queryBackend() {
  ...
  try {
    ...
    const endpoints = [
      { name: 'GET resident', url: 'http://172.20.32.85:3333/admin/resident' },
      { name: 'GET house', url: 'http://172.20.32.85:3333/admin/house' },
      { name: 'GET datawarga', url: 'http://172.20.32.85:3333/admin/datawarga' },
    ];
