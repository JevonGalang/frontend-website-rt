...
export default function Profil() {
  ...
  return (
    <section
      id="profil"
      className="pt-24 sm:pt-28 pb-16 bg-slate-50 border-y border-slate-100"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-20">
          ...
          {/* Content Pane */}
          <div className="lg:col-span-8 bg-white border border-slate-200/60 rounded-3xl p-6 sm:p-10 shadow-lg min-h-[300px]">
            {activeTab === 'visi-misi' && (
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="p-5 rounded-2xl bg-orange-50/50 border border-orange-100">
                    <h4 className="font-bold text-orange-800">Guyub Rukun</h4>
                    <p className="text-sm text-slate-600 mt-2">Menjunjung tinggi kebersamaan, saling tolong-menolong, dan empati sosial antarwarga.</p>
                  </div>
                  <div className="p-5 rounded-2xl bg-orange-50/50 border border-orange-100">
                    <h4 className="font-bold text-orange-800">Transparansi Keuangan</h4>
                    <p className="text-sm text-slate-600 mt-2">Setiap rupiah yang masuk dan keluar dilaporkan secara terbuka agar tidak menimbulkan kecurigaan.</p>
                  </div>
                  <div className="p-5 rounded-2xl bg-blue-50/50 border border-blue-100">
                    <h4 className="font-bold text-blue-800">Respons Cepat</h4>
                    <p className="text-sm text-slate-600 mt-2">Menghadirkan pelayanan administrasi dan koordinasi darurat (keamanan/kesehatan) seefisien mungkin.</p>
                  </div>
                  <div className="p-5 rounded-2xl bg-amber-50/50 border border-amber-100">
                    <h4 className="font-bold text-amber-800">Peduli Lingkungan</h4>
                    <p className="text-sm text-slate-600 mt-2">Mengurangi limbah, merawat taman hijau perumahan, dan melakukan pemilahan sampah berkala.</p>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col items-center justify-center space-y-8">
            ...
            <div className="relative flex flex-col items-center">
              <div className="relative group p-6 rounded-3xl bg-white border border-slate-200/60 shadow-lg text-center w-72 transition-all duration-300 hover:scale-[1.03] hover:shadow-orange-500/10">
                ...
                <div className="relative flex flex-col items-center space-y-4">
                  ...
                  <div>
                    <h4 className="font-extrabold text-slate-950 text-lg">{pengurusList[0].name}</h4>
                    <span className="px-3 py-1 rounded-full bg-orange-500/10 text-orange-600 text-xs font-bold mt-1 inline-block">
                      {pengurusList[0].role}
                    </span>
                  </div>
            ...
            <div className="relative w-full max-w-4xl">
              ...
              <div className="absolute top-0 left-1/4 w-0.5 h-6 bg-slate-200"></div>
              <div className="absolute top-0 right-1/4 w-0.5 h-6 bg-slate-200"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 max-w-2xl mx-auto">
                {pengurusList.slice(1, 3).map((pengurus, index) => (
                  <div key={index} className="flex flex-col items-center">
                    <div className="group p-5 rounded-3xl bg-white border border-slate-200/60 shadow-md text-center w-full max-w-[280px] transition-all duration-300 hover:scale-[1.02] hover:shadow-slate-500/5">
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <div>
                          <h4 className="font-bold text-slate-900">{pengurus.name}</h4>
                          <span className="px-2.5 py-0.5 rounded-full bg-slate-100 text-slate-700 text-[11px] font-bold mt-1 inline-block">
                            {pengurus.role}
                          </span>
                        </div>
