...
* **Response Sukses (200 OK):**
  ...
  *Contoh kode Javascript di Frontend:*
  ...
  const downloadKtp = async (documentId) => {
      const response = await axios.get(`http://172.20.32.85:3333/resident/sensitifdata/file/${documentId}`, {
